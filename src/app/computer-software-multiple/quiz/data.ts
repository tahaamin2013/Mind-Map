export const quiz = {
  ...
  questions: [
    ...
    },
    {
      id: 45,
      question:
        "An operating system is responsible for all of the following EXCEPT: _____",
      answers: [
    ...
    {
      id: 48,
      question: "An example of productivity software is: _____",
    ...
    },
    {
      id: 51,
      question:
        "Educational software can be used for a variety of purposes, including: _____",
      answers: [
        "Playing video games",
    ...
    },
    {
      id: 52,
      question:
        "A high-level programming language is easier to learn and use compared to a low-level language because it is: _____",
      answers: [
    ...
    {
      id: 53,
      question: "Machine language is an example of a: _____",
      answers: [
        "High-level language",
        "Low-level language",
